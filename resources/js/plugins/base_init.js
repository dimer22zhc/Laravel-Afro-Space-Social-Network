...
(function ($) {
  ...
  DIMER.CallToActionAnimation = function () {
  ...
  DIMER.ImgScaleAnimation = function () {
    var controller = new ScrollMagic.Controller()
  ...
  DIMER.SubscribeAnimation = function () {
    var controller = new ScrollMagic.Controller()
  ...
  DIMER.PlanerAnimation = function () {
    var controller = new ScrollMagic.Controller()
  ...
  DIMER.ContactAnimationAnimation = function () {
    var controller = new ScrollMagic.Controller()
  ...
  DIMER.perfectScrollbarInit = function () {
...
$(document).ready(function () {
  ...
  $('.swiper-container').each(function () {
    ...
    var $crossfade = ($t.data('crossfade')) ? $t.data('crossfade') : true
    var $loop = ($t.data('loop') == false) ? $t.data('loop') : true
    ...
    var $mouseScroll = ($t.data('mouse-scroll')) ? $t.data('mouse-scroll') : false
    var $autoplay = ($t.data('autoplay')) ? parseInt($t.data('autoplay'), 10) : 0
    var $autoheight = !!($t.hasClass('auto-height'))
...
DIMER.StickySidebar = function () {
  var $header = $('#site-header')

  $('.DIMER-sticky-sidebar').each(function () {
...
// }
$(function () {
  // Height anmation hack */
  $('.overlay, .facebook_dialog').css('opacity', 1)
  $('.overlay').show()
  var fbheight = $('.fade').height()
  $('.overlay, .facebook_dialog').css('opacity', 0)

  // Remove inline styles
  $('.overlay, .facebook_dialog').removeAttr('style')

  // Set min height to 90px after fbheight has been set*/
  $('.facebook_dialog').css('min-height', '90px')

  // Show dialog when show-dialog button is clicked*/
  ...
  // Close dialog*/
  $('.cancel_button, .close, .okay_button').click(function () {
    $('.overlay, .facebook_dialog, .fade').fadeOut('slow', function () {
      //  Remove inline styles*/
      $('.overlay, .facebook_dialog').removeAttr('style')
    })
  })
